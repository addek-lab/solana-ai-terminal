                    ...
                    {report.risks && report.risks.length > 0 && (
                        <div className="space-y-2">
                            {report.risks.slice(0, 3).map((risk: any, i: number) => (
                                <div key={i} className={`px - 3 py - 2 rounded - lg text - xs font - medium border flex items - center gap - 2 ${
    risk.level === 'danger' ? 'bg-red-500/10 border-red-500/20 text-red-400' :
